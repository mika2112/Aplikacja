<template>
  <div class="alkhole">
    ...
    <div v-for="drink in drinks" :key="drink.id">
      <t v-if="checkIfIsValidDrink(drink.id)"> <!--router-link to="/about"-->  <button @click="newPage">Idź</button> <!--/router-link--><t> </t> {{drink.label}}</t>
      <p></p>
    </div>
...
const drinks = [
  ...
  },
  {
    id: 'longIsland',
    label: 'Long Island',
    components: ['vodka', 'tequila', 'rum', 'gin', 'tripleSec']
  },
  {
    id: 'mojito',
    label: 'Mojijto',
  ...
  }, 
  {
    ...
    components: ['vodka', 'rum', 'gin', 'tequila', 'orangeLiquer']
  },
  {
    id: 'cubaLibre',
    label: 'Cuba libre',
